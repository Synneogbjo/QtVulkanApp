...
// Code made by Marcelo. Thanks for sharing it with me!

float barycentric::getPositionInTerrain(HeightMap* Terrain, float PositionX, float PositionZ)
{
    ...
    for(size_t i = 0; i+2 < indices.size(); i+=3)
    {
        ...
        QVector3D bary = BarycentricCoordinates(ObjPos,a,b,c);
\
...
QVector3D barycentric::BarycentricCoordinates(QVector2D ObjPos, QVector2D p0, QVector2D p1, QVector2D p2)
{
    QVector2D p10 = p1-p0;
    QVector2D p11 = p2-p0;
